...
n_layers = st.sidebar.slider("Layers", 5, 60, 20)
wobble = st.sidebar.slider("Blob Wobble", 0.0, 0.25, 0.05, 0.01)
r_min = st.sidebar.slider("Minimum Radius", 0.05, 0.25, 0.05, 0.01)
r_max = st.sidebar.slider("Maximum Radius", 0.05, 0.25, 0.2, 0.01)
...
shadow_offset = st.sidebar.slider("Shadow Offset", 0.000, 0.100, 0.020, 0.005)
